    ...
    Public Class DriveUploader
        ...
        Function Upload(fileName As String, parents As List(Of String), Optional uploadName As String = Nothing) As String
            Dim fileMetadata As New Data.File() With {
                .Name = CType(If(String.IsNullOrEmpty(uploadName), fileName.Split(CType("\\", Char()))(fileName.Split(CType("\\", Char())).Length - 1).Split(CType(".", Char()))(0) + " " + DateTime.UtcNow.ToString("MM/dd/yyyy"), uploadName), String),
                .Parents = parents
            }
