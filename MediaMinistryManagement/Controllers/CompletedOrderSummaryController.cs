...
namespace MediaMinistryManagement.Controllers
{
    ...
    {
        private readonly CompletedOrderSummaryContext _context;

        public CompletedOrderSummaryController(CompletedOrderSummaryContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Orders
        [HttpGet]
        public async Task<ActionResult<IEnumerable<CompletedOrderSummary>>> GetCustomers()
        {
            return await _context.Completed_Order_Summary.ToListAsync();
        }
        ...
        public async Task<IActionResult> GetOrderItem([FromRoute] int id)
        {
            ...
            var orderItem = await _context.Completed_Order_Summary.FindAsync(id);
        ...
        {
            return _context.Completed_Order_Summary.Any(e => e.ORDER_NUMBER == id);
        }
    }
}